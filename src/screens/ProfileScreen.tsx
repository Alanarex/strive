...
import { resetDatabaseWithDemo } from '../services/database';
...
export default function ProfileScreen({
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    await onUpdateProfile({ name: name.trim(), email: email.trim(), photo });
    setSaving(false);
    setEditing(false);
    ...
    <SafeAreaView style={globalStyles.container}>
      ...
      >
        ...
        <View style={globalStyles.card}>
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              Alert.alert(
                ...
                'Cette action supprime la base locale, recrée un compte démo et recharge l’application.',
                [
          ...
          >
            <Text style={globalStyles.btn_secondary_text}>Réinitialiser les données</Text>
          </TouchableOpacity>
        </View>
